...
#ifndef ROBO_CLEANER_INTERFACES__SRV__DETAIL__CHARGE_BATTERY__FUNCTIONS_H_
#define ROBO_CLEANER_INTERFACES__SRV__DETAIL__CHARGE_BATTERY__FUNCTIONS_H_
...
/// Initialize srv/ChargeBattery message.
/**
...
/// Finalize srv/ChargeBattery message.
/**
...
/// Create srv/ChargeBattery message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robo_cleaner_interfaces__srv__ChargeBattery_Request__init().
...
/// Destroy srv/ChargeBattery message.
/**
 * It calls
 * robo_cleaner_interfaces__srv__ChargeBattery_Request__fini()
...
/// Initialize array of srv/ChargeBattery messages.
/**
...
/// Finalize array of srv/ChargeBattery messages.
/**
 * It calls
 * robo_cleaner_interfaces__srv__ChargeBattery_Request__fini()
...
/// Create array of srv/ChargeBattery messages.
/**
 * It allocates the memory for the array and calls
 * robo_cleaner_interfaces__srv__ChargeBattery_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ChargeBattery messages.
/**
 * It calls
 * robo_cleaner_interfaces__srv__ChargeBattery_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robo_cleaner_interfaces__srv__ChargeBattery_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robo_cleaner_interfaces
...
/**
 * It calls
 * robo_cleaner_interfaces__srv__ChargeBattery_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robo_cleaner_interfaces
...
/**
 * It allocates the memory for the array and calls
 * robo_cleaner_interfaces__srv__ChargeBattery_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robo_cleaner_interfaces
...
/**
 * It calls
 * robo_cleaner_interfaces__srv__ChargeBattery_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBO_CLEANER_INTERFACES__SRV__DETAIL__CHARGE_BATTERY__FUNCTIONS_H_
