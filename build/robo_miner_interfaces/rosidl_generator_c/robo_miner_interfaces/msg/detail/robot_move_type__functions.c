...
{
  robo_miner_interfaces__msg__RobotMoveType * msg = (robo_miner_interfaces__msg__RobotMoveType *)malloc(sizeof(robo_miner_interfaces__msg__RobotMoveType));
  if (!msg) {
    return NULL;
  }
...
robo_miner_interfaces__msg__RobotMoveType__Sequence__init(robo_miner_interfaces__msg__RobotMoveType__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (robo_miner_interfaces__msg__RobotMoveType *)calloc(size, sizeof(robo_miner_interfaces__msg__RobotMoveType));
    if (!data) {
      return false;
    }
...
{
  robo_miner_interfaces__msg__RobotMoveType__Sequence * array = (robo_miner_interfaces__msg__RobotMoveType__Sequence *)malloc(sizeof(robo_miner_interfaces__msg__RobotMoveType__Sequence));
  if (!array) {
    return NULL;
  }
