...
#ifndef ROBO_MINER_INTERFACES__SRV__DETAIL__FIELD_MAP_VALIDATE__FUNCTIONS_H_
#define ROBO_MINER_INTERFACES__SRV__DETAIL__FIELD_MAP_VALIDATE__FUNCTIONS_H_
...
/// Initialize srv/FieldMapValidate message.
/**
...
/// Finalize srv/FieldMapValidate message.
/**
...
/// Create srv/FieldMapValidate message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robo_miner_interfaces__srv__FieldMapValidate_Request__init().
...
/// Destroy srv/FieldMapValidate message.
/**
 * It calls
 * robo_miner_interfaces__srv__FieldMapValidate_Request__fini()
...
/// Initialize array of srv/FieldMapValidate messages.
/**
...
/// Finalize array of srv/FieldMapValidate messages.
/**
 * It calls
 * robo_miner_interfaces__srv__FieldMapValidate_Request__fini()
...
/// Create array of srv/FieldMapValidate messages.
/**
 * It allocates the memory for the array and calls
 * robo_miner_interfaces__srv__FieldMapValidate_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/FieldMapValidate messages.
/**
 * It calls
 * robo_miner_interfaces__srv__FieldMapValidate_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robo_miner_interfaces__srv__FieldMapValidate_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robo_miner_interfaces
...
/**
 * It calls
 * robo_miner_interfaces__srv__FieldMapValidate_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robo_miner_interfaces
...
/**
 * It allocates the memory for the array and calls
 * robo_miner_interfaces__srv__FieldMapValidate_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robo_miner_interfaces
...
/**
 * It calls
 * robo_miner_interfaces__srv__FieldMapValidate_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBO_MINER_INTERFACES__SRV__DETAIL__FIELD_MAP_VALIDATE__FUNCTIONS_H_
